...
float32_t standard_coeffs [5 * 3] = {0.0010,   -0.0000,   -0.0010,   -1.8582,    0.8582,
																			1.0000,    0.7132,    1.0000,   -1.8220,    0.8604,
																			1.0000,  -2.0000,    1.0000,   -1.9998,    0.9998};
//q31_t pCoeffs [5 * 2];
//q63_t pState [4 * 2];
//uint8_t postShift = 0;
//arm_biquad_cas_df1_32x64_ins_q31 filter;
float32_t pState[2*3];
...
int main(void)
{
	...
	arm_biquad_cascade_df2T_init_f32(&filter, 3, standard_coeffs, pState);
